...
//     // ... [your existing pagination and filter code remains the same] ...
...
//     // =============== FIX: APPLY OFFERS TO EACH PRODUCT ===============
...
//         // Return product with offer data
//         return {
//           ...product,
//           // Price data from offer calculation
//           regularPrice: offerData.regularPrice,  // This will be the crossed price
//           finalPrice: offerData.finalPrice,      // This will be the discounted price
...
//     res.render("user/shop", {
//       title: "Shop | BagHub",
//       products: productsWithOffers, // USE THE UPDATED PRODUCTS WITH OFFERS
//       categories: categoriesList,
//       colors: colorsList,
//       brands: brandsList,
//       userWishlistIds,
...
export const getProductDetails = async (req, res) => {
  try {
    ...
    // =============== FIX: APPLY OFFER TO THIS PRODUCT ===============
    const offerData = await applyOfferToProduct(product);
    ...
    // === NEW: pick the offer result for the default (first) variant safely ===
    const defaultVariantOffer =
    ...
    // Related products - ALSO APPLY OFFERS TO THEM
    let relatedProducts = [];
...
export const getVariantByColor = async (req, res) => {
  try {
    ...
    // Apply offer to this specific variant (applyOfferToProduct should return { variants: [...] })
...
//       _id: product._id,
//       productName: product.name,
//       // Use offer calculated prices
//       salePrice: offerData.finalPrice,      // Final discounted price
//       regularPrice: offerData.regularPrice, // Original price to be crossed
//       // Keep variant prices for reference
//       variantPrice: firstVariant.price || 0,
//       variantMRP: firstVariant.mrp || firstVariant.price || 0,
//       // Offer data
...
//       discountPercent: offerData.regularPrice > offerData.finalPrice 
//         ? Math.round(((offerData.regularPrice - offerData.finalPrice) / offerData.regularPrice) * 100)
//         : 0
//     };
...
//           brand: p.brand || "BagHub",
//           // Use offer calculated prices
//           salePrice: relatedOfferData.finalPrice,
//           regularPrice: relatedOfferData.regularPrice,
//           appliedOffer: relatedOfferData.appliedOffer,
//           productImage: [firstImage],
//           rating: p.rating || 4.5,
//           categoryName: p.category?.name || "Other",
//           discountPercent: relatedOfferData.regularPrice > relatedOfferData.finalPrice 
//             ? Math.round(((relatedOfferData.regularPrice - relatedOfferData.finalPrice) / relatedOfferData.regularPrice) * 100)
//             : 0
//         };
//       })
//     );
...
//     // Apply offer to this specific variant if needed
//     const variantProduct = {
//       ...product,
//       variants: [variant] // Only pass the selected variant
//     };
...
//       },
//       // Add offer data for this variant
//       offerData: {
//         regularPrice: offerData.regularPrice,
